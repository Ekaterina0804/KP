...
namespace WpfApp
{
    ...
    internal partial class MessageBoxWindow : Window
    {
        ...
        internal MessageBoxWindow(string message, string caption)
        {
            InitializeComponent();
        ...
        internal MessageBoxWindow(string message, string caption, MessageBoxButton button)
        {
            InitializeComponent();
        ...
        internal MessageBoxWindow(string message, string caption, MessageBoxImage image)
        {
            InitializeComponent();
        ...
        internal MessageBoxWindow(string message, string caption, MessageBoxButton button, MessageBoxImage image)
        {
            InitializeComponent();
