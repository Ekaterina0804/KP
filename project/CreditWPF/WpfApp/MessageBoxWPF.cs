...
namespace WpfApp
{
    ...
    /// </summary>
    public static class MessageBoxWPF
    {        
        /// <summary>
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.OK);
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.OK, icon);
            msg.OKButtonText = okButtonText;
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.OKCancel);
            msg.OKButtonText = okButtonText;
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.OKCancel, icon);
            msg.OKButtonText = okButtonText;
            msg.CancelButtonText = cancelButtonText;
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNo);
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNo, icon);
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNoCancel);
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
            msg.CancelButtonText = cancelButtonText;
        ...
        {
            MessageBoxWindow msg = new MessageBoxWindow(messageBoxText, caption, MessageBoxButton.YesNoCancel, icon);
            msg.YesButtonText = yesButtonText;
            msg.NoButtonText = noButtonText;
            msg.CancelButtonText = cancelButtonText;
